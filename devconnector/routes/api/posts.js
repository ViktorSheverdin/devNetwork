...
router.delete('/:id', auth, async (req, res) => {
  try {
    ...
    // Check if post belongs to the user who created it
...
// @desc Add like to array of likes
// @access Private
...
// @desc Remove like to array of likes
// @access Private
...
router.delete('/comment/:id/:comment_id', auth, async (req, res) => {
  try {
    ...
    // Check the user (if he has create a comment)
